"use strict";
function View(device, rootElement) {
	this._device = device;
...
View.prototype.stateVal = function () {
...
View.prototype.stateChange = function () {
